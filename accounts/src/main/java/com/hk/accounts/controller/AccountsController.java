...
import com.hk.accounts.dto.AccountsContactInfoDto;
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "Get Java version used in the accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get contact info details for the accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
